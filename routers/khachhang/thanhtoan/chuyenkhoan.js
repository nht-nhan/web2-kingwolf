...
router.get('/',asyncHandler (async function(req,res){
    ...
    {
        const thongbao=3;
        return res.render('khachhang/thanhtoan/chuyenkhoan',{thongbao,format_money,get_all_tb,count_all_tb});
    }
    else
    {
        const thongbao=null;
    ...
    try {
        ...
        else
        {
            ...
            else
            {
                ...
                await tb.save_loai_1("L1",req.kwKH.taikhoan.sotaikhoan,stk,tien,nd);
                const thongbao=0;
                res.render('khachhang/thanhtoan/chuyenkhoan',{thongbao,format_money,get_all_tb,count_all_tb});
            }
        }
    } catch (error) {
